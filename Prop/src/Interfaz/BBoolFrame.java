...
public class BBoolFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Introduce el aubool el prefijo que deseas buscar:");
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {                                       
    	 if (bool.getText().isEmpty())JOptionPane.showMessageDialog(null,"Campo de expresion vacio", " Error", JOptionPane.ERROR_MESSAGE);
        	 ...
        	 if(todos == null)JOptionPane.showMessageDialog(null,"No hay documentos con este bool.", " Error", JOptionPane.ERROR_MESSAGE);
        	 else { 
